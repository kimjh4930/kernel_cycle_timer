...
static void update_curr(struct cfs_rq *cfs_rq)
{
	...
	if (now_cycle != 0){
		delta_cycle = now_cycle - curr->exec_start_cycle;
	}
	...
	__update_curr(cfs_rq, curr, delta_exec, delta_cycle);
	curr->exec_start = now;
	curr->exec_start_cycle = now_cycle;
